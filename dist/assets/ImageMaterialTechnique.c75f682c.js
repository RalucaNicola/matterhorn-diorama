import{e8 as C,e9 as P,ea as T,dL as h,eb as x,ec as d,r as v,ed as S,ee as l,ef as O,eg as _,eh as F,ei as m,dR as p,ej as g,ek as b,el as c,em as N,en as y,e as o,eo as r,dW as f,ep as A,eq as D,er as M,es as E,et as w,eu as z,ev as U,ew as W,ex as j,ey as B,ez as I,eA as R,eB as G,eC as L,eD as k,eE as q}from"./index.25dca4c3.js";function H(s){const e=new C;P(e,s),e.include(T),e.attributes.add(h.POSITION,"vec3"),e.attributes.add(h.UV0,"vec2"),e.varyings.add("vpos","vec3"),s.hasMultipassTerrain&&e.varyings.add("depth","float");const{vertex:n,fragment:t}=e;return n.uniforms.add(new x("textureCoordinateScaleFactor",d.Pass,a=>v(a.texture)&&v(a.texture.descriptor.textureCoordinateScaleFactor)?a.texture.descriptor.textureCoordinateScaleFactor:S)),n.code.add(l`
    void main(void) {
      vpos = position;
